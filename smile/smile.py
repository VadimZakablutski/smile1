...
golova=Checkbutton(fm,text="Голова",font="Calibri 26", fg="green",variable=var_golova,onvalue="1",offvalue="0",command=golova1)
var_glaz1=StringVar()
glaz1=Checkbutton(fm,text="Левый глаз",font="Calibri 26", fg="green",variable=var_glaz1,onvalue="1",offvalue="0",command=glaz1)
var_glaz2=StringVar()
glaz2=Checkbutton(fm,text="Правый глаз",font="Calibri 26", fg="green",variable=var_glaz2,onvalue="1",offvalue="0",command=glaz2)
var_rot=StringVar()
rot=Checkbutton(fm,text="Рот",font="Calibri 26", fg="green",variable=var_rot,onvalue="1",offvalue="0",command=rot)
var_nos=StringVar()
nos=Checkbutton(fm,text="Нос",font="Calibri 26", fg="green",variable=var_nos,onvalue="1",offvalue="0",command=nos)
